...
## Code coverage
Here is the following code coverage as generated by Jacoco. Nearly the entire Entity, ABR, and DS layer are covered. A lot of testing of the Framework layer was done manually instead of a test runner.
